<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SqlDataSourceCommonSettingsControl.ascx.vb" Inherits="DotNetNuke.Modules.DTSReports.Controls.SqlDataSourceCommonSettingsControl" %>
